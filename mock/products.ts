...
export const products: Product[] = [
  // ── Dresses ──
  {
    ...
    images: [
      ...
      "/images/08741037746-a6.jpg",
      "/images/08741037746-e2.jpg",
    ],
  ...
  // ── Tops & Blouses ──
  {
    ...
    images: [
      "/images/08741037746-e1.jpg",
      "/images/08741037746-a1.jpg",
      "/images/08741037746-e3.jpg",
      "/images/08741037746-p.jpg",
    ],
  ...
  },
  {
    ...
    images: [
      ...
      "/images/wr-hd3-downpour-ii-2l-rw-jkt-as-4c4ddbf3-fa76-4e3f-a41b-b5d9c04a583b-jpgrendition.avif",
  ...
  // ── New Arrivals — Additional Products ──
  {
    ...
    title: "Linen Blouse & Shorts Set",
    brand: "Atelier Élégance",
    description:
      "A matching set in natural linen — an oversized crochet-trim blouse paired with a tied wrap mini shorts. Effortless resort dressing, styled with strappy leather sandals.",
    images: [
      "/images/08741037746-a6.jpg",
      "/images/08741037746-p.jpg",
      "/images/08741037746-e2.jpg",
    ...
    price: { amount: 28500, currency: "NGN" },
    compareAtPrice: { amount: 36000, currency: "NGN" },
    inStock: true,
    rating: 4.8,
    reviewCount: 34,
    tags: ["dress", "set", "linen", "resort", "co-ord"],
    categoryId: "col-1",
    isNew: true,
    isFeatured: true,
    variants: [
      { id: "v31a", name: "Size", value: "S", stock: 4 },
      { id: "v31b", name: "Size", value: "M", stock: 6 },
      { id: "v31c", name: "Size", value: "L", stock: 3 },
      { id: "v31d", name: "Color", value: "Natural", stock: 8 },
    ],
  },
  {
    id: "p32",
    slug: "levi-denim-trucker-jacket",
    title: "Denim Trucker Jacket",
    brand: "Denim District",
    description:
      "A classic trucker jacket in a dark midnight denim wash. Standard fit with chest flap pockets, adjustable side tabs, and a vintage-inspired cut. A wardrobe essential.",
    images: [
      "/images/levi-s-men-s-denim-standard-fit-trucker-jacket-last-night-425df030-00bd-41c9-9c62-ccc95534f365-jpgrendition.avif",
      "/images/levi-s-men-s-denim-standard-fit-trucker-jacket-last-night-5ace7541-135a-494e-8536-6162d7505c7b-jpgrendition.avif",
    ],
    price: { amount: 42000, currency: "NGN" },
    inStock: true,
    rating: 4.7,
    reviewCount: 118,
    tags: ["activewear", "jacket", "denim", "casual"],
    categoryId: "col-4",
    isNew: true,
    variants: [
      { id: "v32a", name: "Size", value: "S", stock: 5 },
      { id: "v32b", name: "Size", value: "M", stock: 8 },
      { id: "v32c", name: "Size", value: "L", stock: 6 },
      { id: "v32d", name: "Size", value: "XL", stock: 3 },
      { id: "v32e", name: "Color", value: "Dark Indigo", stock: 12 },
    ],
  },
  {
    id: "p33",
    slug: "structured-activewear-set",
    title: "Structured Activewear Set",
    brand: "ActiveZone",
    description:
      "A premium coordinated activewear set engineered for performance and style. Moisture-wicking, 4-way stretch fabric with a sleek silhouette. From gym to street.",
    images: [
      "/images/XM07266_AEG_main.webp",
      "/images/XM07266_AEG_alternate1.webp",
      "/images/XM07266_AEG_alternate3.webp",
      "/images/XM07266_AEG_alternate6.webp",
      "/images/XM07266_AEG_alternate11.webp",
    ],
    price: { amount: 31500, currency: "NGN" },
    compareAtPrice: { amount: 39000, currency: "NGN" },
    inStock: true,
    rating: 4.9,
    reviewCount: 87,
    tags: ["activewear", "set", "gym", "performance"],
    categoryId: "col-4",
    isBestSeller: true,
    variants: [
      { id: "v33a", name: "Size", value: "XS", stock: 6 },
      { id: "v33b", name: "Size", value: "S", stock: 10 },
      { id: "v33c", name: "Size", value: "M", stock: 12 },
      { id: "v33d", name: "Size", value: "L", stock: 8 },
      { id: "v33e", name: "Color", value: "Black", stock: 18 },
      { id: "v33f", name: "Color", value: "Slate Blue", stock: 18 },
    ],
  },
  {
    id: "p34",
    slug: "performance-sports-set",
    title: "Performance Sports Set",
    brand: "ActiveZone",
    description:
      "High-impact performance sports set with seamless construction and targeted compression panels. Flattering, supportive, and designed to move with you through every workout.",
    images: [
      "/images/XM07731_FAP_main.webp",
      "/images/XM07731_FAP_alternate1.webp",
      "/images/XM07731_FAP_alternate3.webp",
      "/images/XM07731_FAP_alternate6.webp",
      "/images/XM07731_FAP_alternate11.webp",
    ],
    price: { amount: 26000, currency: "NGN" },
    inStock: true,
    rating: 4.8,
    reviewCount: 143,
    tags: ["activewear", "set", "sports", "gym"],
    categoryId: "col-4",
    isFeatured: true,
    variants: [
      { id: "v34a", name: "Size", value: "XS", stock: 8 },
      { id: "v34b", name: "Size", value: "S", stock: 12 },
      { id: "v34c", name: "Size", value: "M", stock: 14 },
      { id: "v34d", name: "Size", value: "L", stock: 9 },
      { id: "v34e", name: "Color", value: "Berry", stock: 20 },
      { id: "v34f", name: "Color", value: "Charcoal", stock: 20 },
    ],
  },
  {
    id: "p35",
    slug: "relaxed-knit-top",
    title: "Relaxed Knit Tank Top",
    brand: "Luxe by Finstore",
    description:
      "A beautifully soft knit tank in a relaxed silhouette with a scoop neck and subtle texture. Versatile enough for every occasion, from coffee runs to evening outings.",
    images: [
      "/images/0158c947ad318214c65e5383ca19205084867c76_493970_306_E.webp",
      "/images/24bfecf9d21600a5bbd81f69557c4fc55e0cc3a9_493970_306_B.webp",
      "/images/9a2bc6de2d0c3fcc99c699a0b75a108cc2cddef4_493970_306_C.webp",
      "/images/21ec8f73a38143e4c76c5ff7b40bf2c3ed36842e_493970_306_D.webp",
      "/images/13f133cafa73af581987a801da086e60bdde5b4a_493970_306_F.jpg",
    ],
    price: { amount: 8500, currency: "NGN" },
    compareAtPrice: { amount: 11000, currency: "NGN" },
    inStock: true,
    rating: 4.6,
    reviewCount: 211,
    tags: ["top", "knit", "tank", "casual"],
    categoryId: "col-2",
    isBestSeller: true,
    variants: [
      { id: "v35a", name: "Size", value: "S", stock: 12 },
      { id: "v35b", name: "Size", value: "M", stock: 15 },
      { id: "v35c", name: "Size", value: "L", stock: 10 },
      { id: "v35d", name: "Size", value: "XL", stock: 8 },
      { id: "v35e", name: "Color", value: "Olive", stock: 20 },
      { id: "v35f", name: "Color", value: "Black", stock: 20 },
    ],
  },
  {
    id: "p36",
    slug: "premium-knit-blouse",
    title: "Premium Knit Blouse",
    brand: "Atelier Élégance",
    description:
      "A refined knit blouse with subtle texture and a flattering silhouette. Crafted from a premium soft blend — an elevated everyday essential for the modern wardrobe.",
    images: [
      "/images/64ae627f35fe0c162af8860b132c0420d0b3eaf4_494075_937_B_1acc0c81-9ff2-443d-aa97-fc70a6a6cf27.webp",
      "/images/75ab5c2191c9feda15f9fcd1169ec20716b27148_494075_937_C_a4723542-4700-405a-b330-400d674f7510.webp",
      "/images/89a296ee6803907de6053683534726ada0b8c075_494075_937_E_17139595-5793-4278-bbb0-ebc3bcbe4848.webp",
      "/images/175e543579efcf5ea73ffde14afe9e5ecbfa3a1d_493516_415_C_30ffff14-4d59-4c88-8d82-6f24388b2897.webp",
    ],
    price: { amount: 11500, currency: "NGN" },
    inStock: true,
    rating: 4.7,
    reviewCount: 76,
    tags: ["top", "blouse", "knit", "premium"],
    categoryId: "col-2",
    isNew: true,
    isFeatured: true,
    variants: [
      { id: "v36a", name: "Size", value: "S", stock: 7 },
      { id: "v36b", name: "Size", value: "M", stock: 9 },
      { id: "v36c", name: "Size", value: "L", stock: 6 },
      { id: "v36d", name: "Color", value: "Cream", stock: 12 },
      { id: "v36e", name: "Color", value: "Blush", stock: 10 },
    ],
  },
  {
    id: "p37",
    slug: "textured-knit-cargo-pant",
    title: "Textured Knit Cargo Pant",
    brand: "Casual Chic",
    description:
      "A fashion-forward knit cargo pant combining comfort and utility. Relaxed fit with side cargo pockets and a soft elastic waistband. Styled for the streets, built for comfort.",
    images: [
      "/images/3a31c3eec2e1f4e2f3efb32a4d3a82b125e09271_493047_424_C.webp",
      "/images/06113902055-e1.jpg",
      "/images/08105228429-f1.jpg",
    ],
    price: { amount: 14000, currency: "NGN" },
    compareAtPrice: { amount: 18500, currency: "NGN" },
    inStock: true,
    rating: 4.5,
    reviewCount: 52,
    tags: ["bottoms", "cargo", "knit", "casual"],
    categoryId: "col-3",
    isNew: true,
    variants: [
      { id: "v37a", name: "Size", value: "S", stock: 5 },
      { id: "v37b", name: "Size", value: "M", stock: 7 },
      { id: "v37c", name: "Size", value: "L", stock: 4 },
      { id: "v37d", name: "Color", value: "Stone", stock: 8 },
      { id: "v37e", name: "Color", value: "Khaki", stock: 8 },
    ],
  },
  {
    id: "p38",
    slug: "silver-gold-chain-bracelet",
    title: "Silver & Gold Chain Bracelet",
    brand: "Atelier Élégance",
    description:
      "A bold two-tone chain bracelet featuring alternating silver and gold circular links. Statement jewellery that elevates any outfit — from casual to formal.",
    images: [
      "/images/05718903881-f1.jpg",
    ],
    price: { amount: 6500, currency: "NGN" },
    compareAtPrice: { amount: 9500, currency: "NGN" },
    inStock: true,
    rating: 4.4,
    reviewCount: 38,
    tags: ["accessories", "bracelet", "jewellery", "gold"],
    categoryId: "col-6",
    isNew: true,
    variants: [
      { id: "v38a", name: "Size", value: "One Size", stock: 20 },
      { id: "v38b", name: "Color", value: "Silver/Gold", stock: 20 },
    ],
  },
];
