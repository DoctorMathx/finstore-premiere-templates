  ...
  return (
    <footer className="bg-neutral-950 text-neutral-300 mt-20">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-14">
        {/* Logo + Follow Us */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-10 border-b border-neutral-800">
          <div>
            <Link href="/" aria-label="Finstore home">
              <Image
          ...
          <div className="flex items-center gap-4">
            ...
            {/* TikTok */}
            <a href="#" aria-label="TikTok" className="text-neutral-400 hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Newsletter */}
        <div className="border-t border-neutral-800 pt-10 pb-6">
          <div className="max-w-md">
            <h4 className="text-white font-semibold mb-1">Stay in the loop</h4>
            <p className="text-sm text-neutral-400 mb-4">
              Get early access to new arrivals, exclusive offers and style inspiration.
            </p>
            <form className="flex gap-2">
              <input
                type="email"
                placeholder="Your email address"
                className="flex-1 bg-neutral-900 border border-neutral-700 text-white text-sm px-4 py-2.5 focus:outline-none focus:border-white transition-colors placeholder:text-neutral-500"
              />
              <button
                type="submit"
                className="bg-white text-black text-[11px] font-bold uppercase tracking-wider px-5 py-2.5 hover:bg-neutral-100 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-neutral-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-500">
          <p>© 2026 Finstore. All rights reserved.</p>
